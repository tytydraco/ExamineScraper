...
L-alpha-glycerylphosphorylcholine (shortened to Alpha-GPC usually, also known as choline alphoscerate or glycerophosphocholine) is a choline containing phospholipid[16] and an intermediate of lecithin metabolism or simply a lecithin molecule with two less fatty acids.[17] It is a choline pro-drug, and is known to be a precursor to acetylcholine and phosphatidylcholine in the body following ingestion.[18][19]
...
When controlling for the amount of choline in each supplement, Alpha-GPC requires 46% the dose of CDP-choline[16] and due to being relatively higher in choline on a weight basis, administration of the same doses of either agent result in the group given Alpha-GPC experiencing a greater serum increase in choline.[25] Alpha-GPC is considered to be a more effective (assessed by potency on a weight basis) cholinergic than both choline and CDP-choline when looking at serum values or benefit from clinical interventions.[26][27]
...
Lecithin is metabolized when lysolecithin (from metabolism of lecithin by pancreatic phospholipase[17][31]) is subject to phospholipase B to form glycerophosphorylcholine (synonymous with Alpha-GPC),[32][33][34] which is then readily hydrolyzed by intestinal mucosal cells to form free choline and glycerophosphate (via glycerylphosphorylcholine diesterase[35][17]); this step can potentially be circumvented when lecithin is subject to Phospholipase D in the brain, which directly converts lecithin into glycerophosphate and choline (KM of 0.83).[36][17]
...
Oral ingestion of Alpha-GPC does appear to increase plasma choline concentrations, with one study reporting an increase in plasma choline with 1,000mg Alpha-GPC in otherwise healthy young men from 8.1+/-1.4μmol/L up to 12.1+/-1.9μmol/L (49% at 60 minutes) and 11.4+/-1.7μmol/L (41% at 120 minutes).[39]
...
Alpha-GPC has been noted to be incorporated into brain phospholipids within 24 hours of ingestion in rats,[43] and brain concentrations are increased by either oral ingestion or intravenous injections.[44]
...
It has been noted that Alpha-GPC (150mg/kg) is able to increase dopamine concentrations in the frontal cortex and cerebellum of rats following ingestion which was not seen with an equal dose of choline from CDP-choline[16] and the dopamine metabolite DOPAC has been noted to be increased in the striatum.[44] Alpha-GPC has also been noted to enhance potassium-invoked dopamine release from neurons,[44] which is thought to be due to interactions at the cellular membrane.
...
It has been noted that Alpha-GPC (150mg/kg) is able to increase serotonin concentrations in the frontal cortex and cerebellum of rats following ingestion, which was not seen with CDP-choline.[16]
...
Alpha-GPC has been implicated in GABA release via the noradrenergic system.[52] 30-300mg/kg intraperitoneal injections has been noted to increase GABA release with peak efficacy after 150 minutes (130% of baseline) and potentiated by atropine but not mecamylamine (reaching nearly 160% in half the time) while it was abolished by the alpha-1 adrenergic receptor antagonist prazosin and slightly hindered by physostigmine.[52] The Alpha-1 adrenergic receptor is known to facilitate GABA release.[53][54]
...
One study using Alpha-GPC alongside both caffeine and phosphatidylserine has found increased attention and reaction time in persons undergoing acute stress.[55]

3.8

Memory and Cognition

Protein Kinase C (PKC) is an intracellular intemediate that appears to be associated with memory formation when activated[56][57] and is involved in long term potentiation as well.[58] This activation of PKC is present at a concentration of 50nM[59][60] and may be related to the phospholipid component as a related structure, diacylglyceride, is a known PKC activator.[61]

Administration of Alpha-GPC to rats has been noted to promote PKC translocation in the rat cortex at an oral dose of 600mg/kg[59] peaking at one hour after oral administration[60][62] and either normalizing or dipping below control 5 hours after ingestion.[62] The potency of 600mg/kg Alpha-GPC in activating PKC is similar to 100mg/kg oxiracetam and 30mg/kg Aniracetam (higher doses being ineffective).[60]
...
It has been noted that Alzheimer's Disease (postmortem evaluation) is associated with an increased rate of phospholipid degradation[63] which is hypothesized to be due to an increased requirement of choline (and thus, degrading choline containing phospholipids)[40] as it is well established that acetylcholine can be derived from choline-containing phospholipids (phosphatidylcholine) by a process sometimes referred to as autocannabilism.[64][65]
...
1,000mg Alpha-GPC has elsewhere been shown (intramuscular injections) to have benefit in vascular dementia over 90 days in regards to behavioural, memory, and verbal symptoms. It generally outperforms the same dosage of CDP-choline.[71][27]
...
Growth hormone secretion in response to stimulation (via GHRH) is amplified with administration of Alpha-GPC, and although it is effective in both youth and elderly it seems that elderly persons experience a greater relative increase (due to having less output initially).[76] This was attributed to the cholinergic properties of Alpha-GPC[76] and can occur without exogenous stimulation by GHRH.[39] One trial in otherwise healthy adults given 1,000mg Alpha-GPC noted that plasma choline increased 30-120 minutes postingestion (returning to baseline at 4 hours) and the spike in growth hormone was only reported at 60 minutes (from 1.4+/-1.6 to 4.5+/-2.7ng/mL; 221% increase) which normalized at 120 minutes.[39]
...
The LD50 of orally ingested Alpha-GPC appears to be greater than 10,000mg/kg in rats and mice, and subchronic toxicity studies with 1,000mg/kg in rats leads to slight weight loss and reductions in food consumption.[23] It was said that the No Observed Adverse Effect Level (NOAEL) for humans was at least 150mg/kg over 26 weeks based on extrapolation from dogs.[23]

Alpha-GPC does not appear to possess mutagenic activity.[23]
