...
Upon ingestion of apigenin, it is rapidly metabolized via UDP glucuronosyltransferase UGT1A1 and released into serum as glucuroside and sulfate conjugates.[4][13] A rat study using radiolabelling and liquid scintillation counting (which would detect both apigenin and its metabolites[14]) estimated a terminal half-life of 91.8 hours with a large volume of distribution (259 mL) and low clearance (2 mL/h) using a non-compartmental model.[15] Other rat studies using liquid chromatography (measuring unmetabolized apigenin) and compartmental modeling found elimination half-lives of 4.2[16] and 2.1[17] hours. It is mostly excreted via the urine in the form of glucurosides and sulfate conjugates, but there is some fecal excretion as well due to enterohepatic ejection[13]
...
Apigenin possesses anxiolytic effects by acting as a benzodiazepine ligand, and has no muscle relaxant or sedative effects at normal dosages (3-10mg/kg bodyweight) but sedation was observed at 3 and 10-fold said dose.(30-100mg/kg bodyweight)[18]

3.2

Neurooxidation

Apigenin, in the form of Biapigenin, can exert a neuroprotective effect against excitotoxicity and prevent calcium build-up in neural mitochondria.[19]
...
Apigenin and two glucopyranoside glycosides of Apigenin, from the plant Cephalotaxus sinensis of the Plum Yew family, have been shown to exert anti-diabetic effects in the body by potentiating the GLUT4 response to insulin.[20]
...
Apigenin exerts its anti-inflammatory effects via suppressing the induction of NO-synthase and COX2 enzymes in macrophages via lipopolysacchraide influence.[21] Apigenin also has inhibitory effects on Interleukin-4 production.[22][23] Apigenin may also suppress TNFa elevations via interference with NF-kb transcription[24] and potentially TNFa induced upregulation of adhesion molecule 1.[25]
...
Apigenin can inhibit both aromatase and 17β-hydroxysteroid dehydrogenase (17β-HSD) with the inhibition of 17β-HSD being unique to apigenin and 3 other tested flavonoids (chrysin, genistein and naringenin)[26] and apigenin possessing an IC50 of 300nM (0.3μM). The IC50 of Apigenin on aromatase is approximately 2.9μM (most potent tested flavonoid on aromatase was 7-Hydroxyflavone at 0.21uM, outperforming the reference aminoglutethimide at 1.2uM[26]) and both of these enzymes are involved in testosterone synthesis at different stages.
...
Apigenin has been noted to bind to the VEGF receptors including VEGFR1 (hydrogen bonding at Glu878, Cys912, and Asp1040) and VEGFR2 (Lys868, Cys919, Asp1046) which are similar to the binding sites as the angiogenesis inhibitor Axitinib while the mean binding energy of Apigenin (−8.56kcal/mol and −9.01kcal/mol on VEGFR1 and VEGFR2, respectively) was lower than Axitinib (−12.38kcal/mol and −12.20kcal/mol).[30]

7.2

Mechanisms

Apigenin is known as one of the bioflavonoid compounds in which has high selectivity to induce selective apoptosis of cancer cells in vivo.[31] Like other bioflavonoid compounds apigenin can reduce oxidative stress, induce cell cycle inhibition, increase hepatic detoxification enzyme efficacy, and act as anti-inflammatory to a degree.[32][33]

Laboratory animal studies suggest that apigenin exerts anti-mutagenic properties that occur in response to exogenous toxins and bacteria[34][35] and plays direct roles in metal chelation, free radical scavenging, and induction of phase II detoxification enzymes such as glutathione.[36][37] It is also an inhibitor of the enzyme ornithine decarboxylase, which may promote some tumor growth.[38]

The presence of Apigenin in vivo seems to exert acute protective effects against carcinogenic insults as well.[39][40] 

Other receptor targets of apigenin that may influence carcinogenesis include Heat Shock Proteins[41], telomerase[42], fatty acid synthase[43], the aryl hydrocarbon receptor[44], casein kinase 2 alpha[45], HER2/neu[46], and matrix metalloproteinases[47] It is also a relatively weak xanthine oxidase inhibitor.[48]
