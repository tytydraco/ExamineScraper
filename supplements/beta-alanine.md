...
Carnosine, the active metabolite of beta-alanine, is most abundant in skeletal muscle. Muscle levels of carnosine depend on the metabolic acidosis the animal is subjected to. Deep-sea species of fish, in particular, are thought to maintain high carnosine levels to combat the state of metabolic acidosis induced by low oxygen levels in deep waters.[4] The highest carnosine levels are seen in horses, racing dogs, and the Balaenoptera acutorostrata whale. Farm-raised animals, being less active, would have lower levels of carnosine than wild animals.[5]
...
At equal doses, supplemental beta-alanine appears more effective than supplemental carnosine at increasing muscle carnosine, with all the associated ergogenic benefits.[21]
...
Carnosine can reduce the rate of cellular aging in cultured fibroblasts.[50][51]
This anti-aging effect may be due to carnosine’s ability to reduce the rate of telomere shortening, as was noted at 20 mM in cultured human fibroblasts.[52] Alternatively, it may be due to carnosine’s ability to suppress post-synthetic errors in protein metabolism, since cellular accumulation of altered proteins (damaged protein byproducts in the cytosol) and the subsequent proteotoxic stress are strongly associated with the aging process.[53][54] 

The causative role of toxic proteins in the aging process is strengthened by studies linking reduced aging rates with reduced protein synthesis. A reduction in protein synthesis means a reduction in metabolic byproducts such as protein carbonyls. Also, studies on Caenorhabditis elegans nematodes suggest that, since fewer new proteins are being made, fewer will be misfolded. This will free up chaperone proteins to sequester and help to clear out already existing proteins that may have been damaged through oxidation or glycation.[55][56] A link between reduced aging rate and reduced protein synthesis has also been observed in methionine-deficient mice.[57][58]

Carnosine’s ability to reduce protein alteration may derive from its being an antioxidant, a chelator of toxic metal ions, an anti-glycating agent, and an aldehyde/carbonyl binder.[59] More precisely, carnosine has shown suppressive effects on protein alteration induced by Reactive Oxygen Species (ROS),[60] Reactive Nitrogen Species (RNS),[61] glycating agents such as Advanced Glycation End products (AGEs, which are intimately linked with the aging process[62]),[15][63] and aldehydes such as malondialdehyde (MDA),[64] methylglyoxal (MG),[65] and hydroxynonenal.[66] These latter findings appear to be relevant in vivo: Carnosine-aldehyde adducts have been detected in the urine, indicating they are formed in the body,[67][68] while a carnosine-phosphatidylcholine adduct has been detected in living human leg tissue.[69]
...
Currently, carnosine has shown anti-aging effects in Drosophila flies[79][80] and senescence-accelerated mice.[81][82] The first mice study noted that a 50% survival rate was increased by 20% in animals treated with carnosine. This increase in median lifespan was replicated in the second study, which used an oral dose of carnosine (100 mg/kg/day, which correlates to a little over 8 mg/kg/day in humans, so about 725 mg/day for a 200-lb subject). Both mice studies only noted an increase in median lifespan, with no change in maximum lifespan.
...
Beta-alanine moderates many neurological actions through competitive inhibition of taurine (beta-alanine and taurine compete for the same transporter to get into the brain).[83][84] This is why cells incubated with beta-analine see their taurine stores depleted, either in part[85] or in full.[86]
...
Beta-alanine, when fed to mice over a month, did not appear to significantly influence serotonin or adrenaline levels in the cortex or the hypothalamus. However, it reduced levels of serotonin’s main metabolite, 5-hydroxyindoleacetic acid (5-HIAA), in the hypothalamus.[84] A significant increase in brain carnosine and Brain-Derived Neurotrophic Factor (BDNF) levels were also noted.[84]

In the nucleus accumbens, dopamine levels appear to increase as beta-alanine concentrations increase from 0.1 to 10 mM. Beta-alanine would exert this effect through the glycine receptor, not unlike taurine, alcohol, or glycine itself.[97]

4.3

Interventions

In a mice study comparing the effects of taurine and beta-alanine (22.5 mmol/kg), taurine was more effective at reducing periods of immobility in a Forced Swim Test (suggesting a greater anti-depressive action), while beta-alanine significantly improved performance on an Elevated Plus Maze (suggesting a greater anxiolytic action).[84]
...
As a predictor of Chronic Fatigue Syndrome (CFS), an excess of beta-alanine in the urine has been deemed second only to the presence of amino-hydroxy-N-methyl-pyrrolidine (CFSUM1).[98] In further analysis, urinary beta-alanine was the best predictor of the CFS symptoms of dizziness, hyperesthesia (photophobia included), myalgia and muscle cramps, as well as abdominal pain and gastric reflux.[99] However, a later study of a CFS group found that only a subgroup exhibited elevated urinary beta-alanine levels; the CFS group as a whole was not, in this regard, significantly different than control.[100]
...
Out of the multiple mechanisms of systemic buffering (including proteins and amino acids, bicarbonate, and phosphates), carnosine contributes to intracellular buffering due to the imidazole structure of its histidine residue.[5] Large amounts of histidine dipeptides can be stored in cells with no apparent adverse effects. Theses stores explain why the synthesis or intake of beta-alanine, not histidine, is the rate-limiting step in the production of carnosine. The benefits of beta-alanine are highly associated with how much beta-alanine and carnosine (two buffering agents) are present in a muscle cell prior to contraction.[102]

Due to this buffering, beta-alanine can reduce acidosis without influencing oxygen uptake.[103] Although lactate (lactic acid) does not appear to inhibit muscular contraction per se, it is correlated. This may be due to an accumulation of H+ ions eventually inhibiting muscle contraction and glycolysis.[104] Many studies have noted that buffering acidity in vivo leads, via either direct or indirect mechanisms, to increases in performance in short-term high-intensity exercise.[105]

5.2

Neural Function

Beta-alanine appears to reduce the perception of fatigue and delay volitional exhaustion in women,[106] older individuals (55-92 years old),[107] and collegiate American-football players. The latter study noted a discord between fatigue as measured by subjective ratings (the reduction reached significance) and fatigue as measured by a Wingate anaerobic test (the reduction merely trended toward significance).[108]
...
With regard to beta-alanine supplementation, a 30-day study (4.8 g/day) noted a power increase in resistance-trained men,[110] while a 10-week study (6.4 g/day) found no increase in one-rep max (1RM) or isometric strength in isolation.[34] A previous 4-week study (4.8 g/day) had noted an improvement in the muscular endurance of sprinters during repeated maximal contractions, with no improvement in power during a 400-m sprint test.[19] 

When power-related studies are subjected to meta-analysis,[111] the effect size they reveal, though larger than placebo, fails to reach statistical significance. When only studies on effort lasting 60 seconds or less are pooled (which excludes events like rowing[30]) the effect size is not different from placebo.
...
According to a meta-analysis, the benefits associated with beta-alanine tend to occur with activities lasting 60–240 s. Over that range, benefits decrease. Under that range, benefits are not significant.[111] This meta-analysis also pooled the collective benefit at 2.85% greater than placebo when the median dose was 179 g (total, so about 6 g/day for one month, or 3 g/day for two months), suggesting a minor if statistically significant benefit.[111] The same conclusion can be reached from a 10-week study on elite swimmers: 4 weeks of beta-alanine at 4.8 g/day was associated with a 1.3±1% improvement in performance parameters, but after 6 more weeks at 3.2 g/day statistical significance had been lost.[121]
...
30 days of beta-alanine supplementation at 4.8 g/day, which was able to increase workout capacity, did so without influencing the testosterone response to exercise in healthy males.[110] This lack of effect has also has been observed with preformed carnosine.[125]

7.2

Cortisol

30 days of beta-alanine supplementation at 4.8 g/day, which was able to increase workout capacity, did so without influencing the cortisol response to exercise in healthy males.[110]

7.3

Growth Hormone

30 days of beta-alanine supplementation at 4.8 g/day, which was able to increase workout capacity, did so without influencing the growth hormone response to exercise in healthy males.[110]
...
Paresthesia typically occurs when too great a dose of beta-alanine is taken acutely. It can be avoided by taking extended-release formulations[132][47] or smaller doses (800 mg on average, or 10 mg/kg in sedentary individuals) at least 3 hours apart (based on the time to peak serum levels, the compound half-life, and the time to return to baseline).[102] One study used 1-g doses every other hour (5 g/day).[30]
