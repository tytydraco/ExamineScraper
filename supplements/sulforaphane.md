...
AMPK is able to directly induce glycerol release and cause fat loss, but its inhibition may do the same secondary to increased CPT1A, as evidenced by Compound C (an AMPK inhibitor).\[46]
